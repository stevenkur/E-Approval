...
class RejectClaim extends Mailable
{
    ...
    public function build(Request $request)
    {
        ...
        $staff = $staffs[0];
        return $this->markdown('emails.rejectclaim', ['claim'=>$claim, 'comment'=>$comment, 'staff'=>$staff])->subject('Claim Registration Number ' . $claim->id_claim . ' has been rejected by ' . $staff->nama_role)->to($email[0]->email);
    }
}
