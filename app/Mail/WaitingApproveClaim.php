...
class WaitingApproveClaim extends Mailable
{
    ...
    public function build(Request $request)
    {
        ...
        $staff = $staffs[0];
        return $this->markdown('emails.waitingapproveclaim', ['claim'=>$claim, 'comment'=>$comment, 'staff'=>$staff])->subject('New Claim Registration Number ' . $claim->id_claim . ' needs to be approved ')->to($staff->email);
    }
}
